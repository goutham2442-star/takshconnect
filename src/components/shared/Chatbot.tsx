    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      <AnimatePresence>
        {isOpen && !isMinimized && (
          ...
          >
            {/* Header */}
            <div className="p-4 border-b border-white/10 flex items-center justify-between bg-maroon/10">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-maroon flex items-center justify-center">
            ...
            <div className="p-4 border-t border-white/10 bg-navy/50">
              <div className="relative">
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm text-white placeholder:text-white/20 focus:outline-none focus:border-gold/50 transition-all"
                />
                <button 
                  onClick={handleSend}
      ...
      <motion.button
        ...
        className="w-14 h-14 rounded-full bg-maroon shadow-lg shadow-maroon/30 flex items-center justify-center text-gold border-2 border-gold/20"
      >
